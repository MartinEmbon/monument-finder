...
function MonumentPage() {
    ...
    }, [showAd]); // Adding showAd as a dependency to rerun the effect when it changes
  
    useEffect(() => {
      // Fetch the monument data
    ...
    return (
      <div className="monument-page">
        ...
        <section className="monument-advertisement">
          ...
          <p>Explora más sobre la rica historia de Corrientes. Visita el sitio oficial de turismo para conocer las últimas novedades.</p>
